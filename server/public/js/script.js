const config = {
    serverInfo: {
        serverLogoImageFileName: "../img/logo.png", /*This is a file name for logo in /images/ (If you upload new logo with other name, you must change this value)*/
        serverName: "System Bot", /*Server name*/
        serverIp: "System Bot",
        discordServerID: "1200557940277530704" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
...
const setDataFromConfigToHtml = async () => {
    ...
    serverLogo.src = `img/` + config.serverInfo.serverLogoImageFileName;
